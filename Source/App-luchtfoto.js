...
var LufoServerWMSURL = 'https://zldlufow3.zeeland.nl/geoserver/Lufo/wms?';


function setLufo(terrainProviderAlias)
{
	// sets the default lufo
	var lufoProvider = new Cesium.WebMapServiceImageryProvider({url: LufoServerWMSURL, layers :'Zld_2020_5cm'});
	viewer.scene.imageryLayers.addImageryProvider(lufoProvider);
...
function setTerrain(terrainProviderAlias)
{
  ...
  if (terrainProviderAlias == 'terrainT0')
	{
		//viewer.imageryLayers.removeAll();
		//load the defaulr lufo
		self.setLufo(terrainProviderAlias);
